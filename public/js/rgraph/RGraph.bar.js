                    ...
                    */
                    ...
                    // Arrow chart
                        ...
                        this.context.beginPath();
                            ...
                            this.context.lineTo(AA(this, x + hmargin + (barWidth / 2)), y + (this.Get('chart.xaxispos') == 'center' && (this.data[i] < 0) ? height : 0));
                            ...
                            this.context.moveTo(AA(this, x + hmargin + (barWidth / 2)), y + (this.Get('chart.xaxispos') == 'center' && (this.data[i] < 0) ? height : 0));
                            this.context.arc(x + hmargin + (barWidth / 2),
                                             y + (this.Get('chart.xaxispos') == 'center' && (this.data[i] < 0) ? height : 0),
                                             5,
                ...
                */
                    ...
                    for (j=0; j<this.data[i].length; ++j) {
                        ...
                        */
                        ...
                        var groupedMargin = this.Get('chart.hmargin.grouped');

    ...
    */
    RGraph.Effects.Fade.In = function (obj)
    {
        ...
        for (var i=1; i<=10; ++i) {
            setTimeout('document.getElementById("' + canvas.id + '").style.opacity = ' + (i * 0.1), i * (duration / 10));
        }
    ...
    */
    RGraph.Effects.Fade.Out = function (obj)
    {
        ...
        // Now fade the chart in
        for (var i=10; i>=0; --i) {
            setTimeout('document.getElementById("' + canvas.id + '").style.opacity = ' + (i * 0.1), (10 - i) * (duration / 10));
        }

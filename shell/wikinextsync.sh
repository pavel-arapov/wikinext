...
# Author: Pavel Arapov <pavel.arapov@gmail.com>
#
...
DAEMON_ARGS="/home/apps/wikinext_github/wikinext/share.js"               # path to your node.js server/app
                                            # NB: don't use ~/ in path
DESC="wikinext syncedit server"                  # whatever fancy description you like
